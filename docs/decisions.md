...
| ADR-015 | Runtime Verification Integration | Active | POST_VERIFY executes whitelisted build/lint/test commands. |
...
**Note:** ADR-ASK-001 introduces the ASK-XXX sub-series for routing governance ADRs, distinct from the product ADR series (ADR-001 through ADR-018).
